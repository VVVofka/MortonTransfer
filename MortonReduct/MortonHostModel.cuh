...
Ar4 kF(size_t n){
	...
	return std::array<Ar4, 16>{
		Ar4{0.3, 0.3, 0.3, 0.3},	// 0000
		Ar4{-0.2, 0.1, 0.1, 0.1},	// 0001
		Ar4{0.1, -0.2, 0.1, 0.1},	// 0010
		Ar4{0.0, 0.0, 0.0, 0.0},	// 0011

		Ar4{0.1, 0.1, -0.2, 0.1},	// 0100
		Ar4{0.0, 0.0, 0.0, 0.0},	// 0101
		Ar4{0.0, 0.0, 0.0, 0.0},	// 0110
		Ar4{-0.1, -0.1, -0.1, -0.1},// 0111

		Ar4{0.1, 0.1, 0.1, -0.2},	// 1000
		Ar4{0.0, 0.0, 0.0, 0.0},	// 1001
		Ar4{0.0, 0.0, 0.0, 0.0},	// 1010
		Ar4{-0.1, -0.1, 0.2, -0.1},	// 1011

		Ar4{0.0, 0.0, 0.0, 0.0},	// 1100
		Ar4{-0.1, 0.2, -0.1, -0.1},	// 1101
		Ar4{0.2, -0.1, -0.1, -0.1},	// 1110
		Ar4{-1.0, -1.0, -1.0, -1.0}	// 1111
	}[n];
}
