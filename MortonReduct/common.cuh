...
__device__ __host__ __forceinline__ uint64_t pack64(uint64_t a){ // 64 -> 16
	return
		((a & 0x1000'0000'0000'0000) >> 45) | ((a & 0x100'0000'0000'0000) >> 42) | ((a & 0x10'0000'0000'0000) >> 39) | ((a & 0x1'0000'0000'0000) >> 36) |
		((a & 0x1000'0000'0000) >> 33) | ((a & 0x100'0000'0000) >> 30) | ((a & 0x10'0000'0000) >> 27) | ((a & 0x1'0000'0000) >> 24) |
		((a & 0x1000'0000) >> 21) | ((a & 0x100'0000) >> 18) | ((a & 0x10'0000) >> 15) | ((a & 0x1'0000) >> 12) |
		((a & 0x1000) >> 9) | ((a & 0x100) >> 6) | ((a & 0x10) >> 3) | (a & 0x1);
} // -----------------------------------------------------------------------------------------------
